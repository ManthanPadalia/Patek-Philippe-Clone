...
<body>
    <div class="navbar">
      <img src="logo-patek.jpg" height="80px">
    </div><br>
    <div class="main1">
        <h2 style="text-align: center; color: #BFAF9E">REGISTER </h2>
        <div class="login-container">
            <form action="#" method="post">
                ...
                <div class="input-field">
                    <label for="username" style="font-weight: 600; color: #BFAF9E">Username</label><br>
                ...
                <div class="input-field">
                    <label for="emailaddress" style="font-weight: 600; color: #BFAF9E">Email address</label><br>
                    <input class="input-field" type="email" id="emailaddress" name="email" class="input-field" placeholder="  Enter Your Email" required>
                </div>
                <div class="input-field">
                    <label for="password" style="font-weight: 600; color: #BFAF9E">Password:</label><br>
                    <input class="input-field password" type="password" name="password" placeholder=" Enter Your Password"required>
                </div>
                <div class="input-field">
                    <label for="password" style="font-weight: 600; color: #BFAF9E">Confirm Password:</label><br>
